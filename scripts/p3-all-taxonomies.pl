=head1 Return All Taxonomic Groupings in PATRIC

    p3-all-genomes [options]

This script returns the IDs of all the taxonomic groupings in the PATRIC database. It supports standard filtering
