...
=head1 Return Data from Sequence Feature Variants in BV-BRC

    p3-get-sfvt-data.pl [options]

A sequence feature variant describes a variation of a sequence feature. The standard input should contain the sequence feature
variant IDs.
