...
=head1 Return Protein Structures for Genomes

    p3-get-feature-protein-structures.pl [options]

This script takes as input a list of PATRIC genome IDs and outputs the protein structures associated with each.
